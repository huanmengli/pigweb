...
//    母猪一次一共生了多少
    @Excel(name = "母猪一次一共生了多少")
    private Integer pigOneNum;
...
//    母猪生育第几窝
    ...
    public Integer getPigOneNum() {
        return pigOneNum;
    }

    public void setPigOneNum(Integer pigOneNum) {
        this.pigOneNum = pigOneNum;
    }
    @Override
